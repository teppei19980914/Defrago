...
@pytest.fixture
def logic(repo: DbGtdRepository) -> OrganizationLogic:
...
class TestOrganizationLogic:
    ...
    def test_get_unorganized_tasks(
        self, logic: OrganizationLogic, repo: DbGtdRepository
    ):
